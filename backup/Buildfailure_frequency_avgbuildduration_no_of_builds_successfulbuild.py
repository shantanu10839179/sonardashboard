...
GITHUB_REPOS = [
    ...
    "shantanu10839179/devsecopsdashboard","shantanu10839179/test_sonar","shantanu10839179/sonardashboard"
]
    ...
    try:
        ...
        for i, run in enumerate(sorted_runs):
            ...
            if run['conclusion'] == 'failure':
                failure_reason = run.get('output', {}).get('title', '') or run.get('output', {}).get('summary', '')
                if not failure_reason:
                    failure_reason = run.get('name', '')
